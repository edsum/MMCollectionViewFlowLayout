...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/sumlunmao/podTestLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'sumlunmao' => '313204141@qq.com' }
  s.source           = { :git => 'https://github.com/sumlunmao/podTestLibrary.git', :tag => s.version.to_s }
